...
/**
 * @dev The official Lazy Coin smart contract
 */
contract LazyCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "Lazy Coin (LAZYCOIN.NET)";
    string private _symbol   = "LAZY";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for LazyCoin/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x24eC43D7C90c7C21A12C7A0C18d29Cc20D91E0d9); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion Lazy Coin will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-Lazy Coin tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts Lazy Coin balance for buybacks, Farming, liquidity and marketing
    ...
    /**
     * @notice Burns LazyCoin tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of LazyCoin tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from LazyCoin)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of LazyCoin
            path,
